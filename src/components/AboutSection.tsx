...
export const AboutSection = ({ currentLang }: { currentLang: string }) => {
  ...
  const stats = [
    { value: 3, label: currentLang === 'es' ? 'Años de experiencia' : 'Years of experience' },
    { value: 50, label: currentLang === 'es' ? 'Proyectos completados' : 'Completed projects' },
    { value: 20, label: currentLang === 'es' ? 'Tecnologías dominadas' : 'Technologies mastered' },
    { value: 100, label: currentLang === 'es' ? 'Satisfacción del cliente' : 'Client satisfaction' }
  ];
